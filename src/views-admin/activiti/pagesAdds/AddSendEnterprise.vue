    ...
    <el-card :header="title" shadow="never" style="height:90vh" class="card">
      ...
      <div class="content">
        <el-form ref="form" :model="rulesForm" label-width="120px" :rules="rules">
          ...
          <el-form-item label="企业身份" prop="crorpid">
            <el-input v-model="rulesForm.crorpid" placeholder="请输入企业身份" />
          </el-form-item>
          <el-form-item label="企业身份密钥" prop="corpsecret">
            <el-input v-model="rulesForm.corpsecret" placeholder="请输入企业身份密钥" />
          </el-form-item>
          ...
          <el-form-item label="企业微信二维码" prop="avatar">
            <FileUpload
              button-text="选择图片"
              upload-type="pic"
              file-type=".png,.jpg"
  ...
  data() {
    return {
      ...
      rules: {
        ...
        crorpid: [{ required: true, message: '请输入', trigger: 'blur' }],
        corpsecret: [{ required: true, message: '请输入', trigger: 'blur' }]
