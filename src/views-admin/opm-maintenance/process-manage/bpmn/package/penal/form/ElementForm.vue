  ...
  <div class="panel-tab__content">
    ...
    <el-drawer :visible.sync="fieldModelVisible" title="字段配置" :size="`${width}px`" append-to-body destroy-on-close>
      ...
      <template v-if="formFieldForm.type === 'enum'">
        ...
        <el-table key="enum-table" :data="fieldEnumList" size="mini" max-height="240" border fit>
      ...
      <el-table key="validation-table" :data="fieldConstraintsList" size="mini" max-height="240" border fit>
        <el-table-column label="序号" width="50px" type="index" />
      ...
      <el-table key="property-table" :data="fieldPropertiesList" size="mini" max-height="240" border fit>
        <el-table-column label="序号" width="50px" type="index" />
