...
export default {
  ...
  methods: {
    resetListenersList() {
      ...
      this.elementListenersList.forEach(item => {
        item.id = this.$tool.guid()
      })
    },
    ...
    changeListen(val) {
      if (val === 'classListener') this.$set(this.listenerForm, 'class', 'com.hy.listener.TaskListenerService')
    },
    loadMoreUser() {
