  ...
  <div class="todo-handle">
    ...
    <div class="rightContainer">
      <div class="tabsAndTable">
        <MatterTabs ref="MatterTabs" item-type="todo-handle" :statistics-count-param="statisticsCountParam" :user-group-ids="groupIds" :tabs-list="tabsList" @emitSetTableList="emitSetTableList" @emitHandlerSearch="emitHandlerSearch" />
      </div>
      <div class="tableWrapper">
        <MatterTable item-type="todo-handle" :table-data="tableData" :table-count="tableCount" @emitGetPagingTableData="emitGetPagingTableData" />
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  async mounted() {
    const typeTabs = await this.$store.dispatch('opm/getTypeTabs', {type: 'todo-handle'})
