    ...
    <el-dialog title="栏目配置" :visible.sync="dialogVisible" width="80%" @close="$emit('update')">
      ...
      <div class="table-wrapper">
        ...
        >
          ...
          <el-table-column label="所属设备" prop="device" show-overflow-tooltip>
...
export default {
  ...
  methods: {
    ...
    async findHyitDhMenuValue() {
      let { code, data } = await request({ url: api.powerEnv.findHyitDhMenuValue, data: { columnId: this.info.dhMenuItem.id }})
      if (code !== 1) return
