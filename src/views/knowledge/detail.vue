<template>
  <div class="left2">
    <div class="page-nav">
      <!-- <div @click="$router.back()"><i class="el-icon-back" />返回</div> -->
...
<style lang="scss">
    .left2{
        ...
        .left_title{font-size: 24px;font-weight: 700;line-height: 50px;margin: 0;}
        .Subframe{
          margin:0 0 25px 0;
          .left_type,.left_time{font-size: 14px;color: rgba(0,0,0,.5);line-height: 30px;}
          .left_type{padding: 0;}
          .left_time{padding: 0 20px;}
        ...
        .kewordBox{padding: 35px 0 0 20px;color: #333333;
            ...
            .keywords{display: flex;font-size: 14px;
                ...
                .keyword{background-color: #f5f5f5;font-size: 12px;padding: 4px;border-radius: 999rem;padding: 0 16px;display: flex;align-items: center;line-height: 35px;margin:10px;margin-right: 15px;color: #333;}
            }
