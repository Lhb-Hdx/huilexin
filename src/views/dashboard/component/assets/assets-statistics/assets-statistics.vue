    ...
    <div class="box-item-content content-height-300">
      ...
      <div class="item-content-body flexBox align-item-center">
        <div class="echart-box">
          <div id="assetsStatisticsEcharts" ref="assetsStatisticsEcharts" style="height: 220px" />
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      modelDefine: 'assetsStatistics',
      watchItemShow: null,
      dashboardType: 4,
      modelShow: '',
      devStatus: [
        { value: 0, name: '网络设备', color: '#ea605c' },
        { value: 0, name: '机电设备', color: '#ea8735' },
        { value: 0, name: '办公设备', color: '#4da88b' },
        { value: 0, name: '办公座椅', color: '#9b999c' }
      ]
    }
  },
  mounted() {
  ...
  methods: {
    ...
    createEcharts() {
      ...
      const self = this
      const opsChartsObj = echarts.init(self.$refs['assetsStatisticsEcharts'])
      const option = {
