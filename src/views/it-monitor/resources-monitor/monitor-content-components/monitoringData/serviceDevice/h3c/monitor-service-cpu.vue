<template>
  <div class="table-wrapper width-100">
    ...
    >
      ...
      <el-table-column label="线程数" prop="threadItemValue" show-overflow-tooltip />
      <el-table-column label="核心数" prop="nuclearItemValue" show-overflow-tooltip />
      <el-table-column label="当前频率" show-overflow-tooltip>
        <template slot-scope="{row}">
          <span>{{ setStorage(row.frequencyItemValue, row.frequencyUnits) }}</span>
        </template>
      </el-table-column>
