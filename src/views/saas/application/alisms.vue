  ...
  <div class="wrp">
    ...
    <div class="bodyBox">
      <el-table :data="data" stripe border style="width: 100%">
        ...
        <el-table-column prop="crorpid" label="服务区码"><template slot-scope="scope">
          <div>{{ scope.row.crorpid }}</div>
        </template></el-table-column>
        <el-table-column prop="corpToken" label="模板码"><template slot-scope="scope">
