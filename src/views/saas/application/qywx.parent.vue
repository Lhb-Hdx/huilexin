  ...
  <div class="wrp">
    ...
    <div class="bodyBox">
      <el-table :data="data" stripe border style="width: 100%">
        ...
        <el-table-column prop="agentId" label="AgentId" width="80"><template slot-scope="scope">
          <div>{{ scope.row.agentId }}</div>
        </template></el-table-column>
        <el-table-column prop="suiteId" label="SuiteId"><template slot-scope="scope">
          <div>{{ scope.row.suiteId }}</div>
        </template></el-table-column>
        <el-table-column prop="corpToken" label="Token"><template slot-scope="scope">
          <div>{{ scope.row.corpToken }}</div>
        </template></el-table-column>
        <el-table-column prop="corpEncodingAesKey" label="EncodingAesKey"><template slot-scope="scope">
          <div>{{ scope.row.corpEncodingAesKey }}</div>
        </template></el-table-column>
      ...
      <div class="drawer-wrp">
        <el-form label-position="left" class="demo-table-expand">
          ...
          <el-form-item label="AgentId">
            <el-input v-model="model.agentId" type="text" />
          </el-form-item>
          <el-form-item label="suiteId">
            <el-input v-model="model.suiteId" type="text" />
          </el-form-item>
          <el-form-item label="suiteSecret">
            <el-input v-model="model.suiteSecret" type="text" />
          </el-form-item>
          <el-form-item label="Token">
            <el-input v-model="model.corpToken" type="text" />
          </el-form-item>
          <el-form-item label="EncodingAesKey">
            <el-input v-model="model.corpEncodingAesKey" type="text" />
          </el-form-item>
          <el-form-item label="">
...
export default {
  ...
  data () {
    return {
      classify: 'qywx.parent',
      keyword: null, page: 1, limit: 10, pageSize: [10, 20, 30, 40, 50], data: [], loading: false, total: 0, editorDrawer: false,
      model: { applicationId: null, applicationName: null, agentId: null, crorpid: null, corpsecret: null, corpToken: null, corpEncodingAesKey: null, suiteId: null, suiteSecret: null, status: 'enable', classify: this.classify }
    }
  },
  mounted () {
    this.loadData()
  ...
  methods: {
    ...
    onAdd () {
      this.model = { applicationId: 0, applicationName: null, agentId: null, crorpid: null, corpsecret: null, corpToken: null, corpEncodingAesKey: null, suiteId: null, suiteSecret: null, status: 'enable', classify: this.classify }
