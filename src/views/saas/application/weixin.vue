...
export default {
  ...
  data () {
    return {
      classify: 'weixin', keyword: null, page: 1, limit: 10, pageSize: [10, 20, 30, 40, 50], data: [], loading: false, total: 0, editorDrawer: false, model: { applicationId: null, applicationName: null, appKey: null, secret: null, status: 'enable', classify: this.classify }
    }
  },
  mounted () {
    this.loadData()
